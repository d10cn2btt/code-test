<div class="form-group @if ($errors->has('title')) error-control @endif">
    <label class="form-label" for="title">{{trans('admin.fields.notes.title')}}<span class="required"> *</span></label>
...
<div class="form-group @if ($errors->has('body')) error-control @endif">
    <label class="form-label" for="title">{{trans('admin.fields.notes.body')}}</label>
...
<div class="form-group @if ($errors->has('status')) error-control @endif">
    {!! Form::label('status', trans('admin.fields.notes.status'), array('class' => 'form-label')) !!}
